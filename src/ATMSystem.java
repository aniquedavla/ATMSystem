...
public class ATMSystem {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Account acctA2 = new Account(new CashCard("A101","04/19"),"mypassword2",100);
        bankA.addAccount(acctA2);

        Bank bankB = new Bank("B");
        Account acctB1 = new Account(new CashCard("B120","01/2012"),"123",100);
        bankB.addAccount(acctB1);
        Bank bankB2 = new Bank("B");
        Account acctB12 = new Account(new CashCard("B121","04/2020"),"1234",100);
        bankB.addAccount(acctB1);
